...
- 🏙️ **3D 빌딩숲 아트** — QR 매트릭스를 밤의 아이소메트릭 도시로 (Three.js · InstancedMesh · 창문 불빛·블룸·황혼 안개)
...
- 🌐 **한국어 / 영어** — 브라우저 언어 자동감지 + 헤더에서 즉시 전환
- 📲 **웹앱 설치(PWA)** — 홈 화면에 설치 · 서비스워커로 오프라인 동작
...
- 광고 SDK·개인 추적 없음
- 웹사이트만 **쿠키 없는 익명 방문 통계**(Vercel Web Analytics) 사용 — **Android 앱은 미수집**
